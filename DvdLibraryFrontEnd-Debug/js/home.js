...
function checkAndDisplayValidationErrors_Search(input) {
  ...
  //a place to hold error messages
    ...
    if (input == '') {
        errorMessages.push(errorField + ' ' + "The Search Field Input Was Empty");
    } // how to fix if input is empty
  ...
  input.each(function(){
    ...
    //if(true)
    {
      ...
      if(errorField == "") {
      errorMessages.push(errorField + ' '+ "Please Enter a valid Search Term");
      }
